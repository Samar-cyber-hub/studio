...
const styleToPromptEnhancement: Record<AnimationStyle, string> = {
  ...
  "3d_avatar_portrait": "Produce a high-quality 3D talking avatar portrait concept. The character MUST be facing directly forward, with a clear view of the face and upper body, suitable for a virtual presenter or character model. Ensure the face is well-lit and expressions are clear.",
